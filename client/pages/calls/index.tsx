...
export default function CallsIndex() {
  ...
  return (
    <>
      <Head>
        <title>VoIP Video Calls | YouTube Clone</title>
        <meta name="description" content="Start or join a real-time secure video call with your friends on YouTube Clone." />
      </Head>
